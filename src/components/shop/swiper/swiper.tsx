...
export default function App() {
  ...
  return (
    <>
      <div className="flex gap-4 absolute bottom-70 right-12  z-[99] text-xl">
        <button className="glass-backdrop custom-prev ">
          <GrNext className="text-white" />
        </button>
        <button className="glass-backdrop custom-next">
